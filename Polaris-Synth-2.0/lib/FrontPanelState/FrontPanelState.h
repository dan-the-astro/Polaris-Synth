...
class FrontPanelState {
    ...
    public:
        ...
        int32_t LFO_frequency = 0; // Q16.16 fixed point
        ...
        int32_t OscA_frequency = 0; // Q16.16 fixed point
        int32_t OscA_pulse_width = 0; // Q16.16 fixed point
        ...
        int32_t OscB_frequency = 0; // Q16.16 fixed point
        int32_t OscB_pulse_width = 0; // Q16.16 fixed point
        int32_t OscB_fine = 0; // Q16.16 fixed point
        ...
        int32_t Wheel_source_mix = 0; // Q16.16 fixed point
        ...
        // Filter parameters
        int32_t Filter_cutoff = 0; // Q16.16 fixed point
        int32_t Filter_resonance = 0; // Q16.16 fixed point
        int32_t Filter_env_amt = 0; // Q16.16 fixed point
        int32_t Filter_attack = 0; // Q16.16 fixed point
        int32_t Filter_decay = 0; // Q16.16 fixed point    
        int32_t Filter_sustain = 0; // Q16.16 fixed point
        int32_t Filter_release = 0; // Q16.16 fixed point
        bool Filter_keytrack = false; // is Filter keytracking enabled

        // Amp envelope parameters
        int32_t Amp_attack = 0; // Q16.16 fixed point
        int32_t Amp_decay = 0; // Q16.16 fixed point
        int32_t Amp_sustain = 0; // Q16.16 fixed point
        int32_t Amp_release = 0; // Q16.16 fixed point

        // Misc parameters
        int32_t Master_level = 0; // Q16.16 fixed point
        int32_t Glide_rate = 0; // Q16.16 fixed point
